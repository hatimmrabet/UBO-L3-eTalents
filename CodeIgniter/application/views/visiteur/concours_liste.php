...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
	...
	<tbody>
		...
		<tr>
			...
			<td><a class="btn btn-dark btn-sm btn-block" href="<?php echo base_url().'index.php/visiteur/afficher_details_concours/'.$cnc["cnc_id"] ?>" role="button">Plus d'info...</a>
				<?php if($cnc["phase"]=="Candidature") { ?>
					<a class="btn btn-primary btn-sm btn-block" href="<?php echo base_url().'index.php/visiteur/inscription/'.$cnc["cnc_id"] ?>" role="button">S'inscrire</a>
				<?php } if($cnc["phase"]=="Evaluation") { ?>
					<a class="btn btn-warning btn-sm btn-block" href="<?php echo base_url()."index.php/visiteur/afficher_preselection/".$cnc["cnc_id"]?>" role="button">Candidats Présélectionnés</a>
