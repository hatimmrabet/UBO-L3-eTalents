<div class="container-fluid" style="width: 85%;">
	...
	<div class="row">
		...
		<div class="col-xl-3 col-md-6 mb-4">
			<a style="text-decoration: none;" href="<?php echo base_url();?>index.php/organisateur/informations_compte">
		...
		<!-- Concours -->
		<div class="col-xl-3 col-md-6 mb-4">
			<a style="text-decoration: none;" href="<?php echo base_url();?>index.php/organisateur/afficher_concours">
		...
		<!-- Comptes -->
		<div class="col-xl-3 col-md-6 mb-4">
			<a style="text-decoration: none;" href="<?php echo base_url();?>index.php/organisateur/lister_comptes">
				<div class="card border-left-primary shadow h-100 py-2">
					<div class="card-body">
						<div class="row no-gutters align-items-center">
							<div class="col mr-2">
								<div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Comptes</div>
								<div class="h8 mb-0 text-gray-800">Tous les comptes</div>
							</div>
							<div class="col-auto">
