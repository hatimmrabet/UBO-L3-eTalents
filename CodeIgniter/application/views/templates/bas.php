			...
			<footer class="sticky-footer sticky-bottom bg-white">
				<div class="container my-auto">
					<div class="copyright text-center my-auto">
						<span>All Copyright &copy; reserved to <bold>e-Talents Football FreeStyle</bold> Website</span>
					</div>
				</div>
			</footer>
			<!-- End of Footer -->
  ...
  <!-- Scroll to Top Button-->
	...
	<script src="<?php echo base_url();?>style/js/sb-admin-2.min.js"></script>

	<!-- Page level plugins -->
	<script src="<?php echo base_url();?>style/vendor/chart.js/Chart.min.js"></script>

	<!-- Page level custom scripts -->
	<script src="<?php echo base_url();?>style/js/demo/chart-area-demo.js"></script>
	<script src="<?php echo base_url();?>style/js/demo/chart-pie-demo.js"></script>
</body>
</html>