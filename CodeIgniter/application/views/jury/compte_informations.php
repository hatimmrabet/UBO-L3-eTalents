      ...
      <div class="table-responsive">
        <table class="table " id="dataTable" width="100%" cellspacing="0">
          ...
          <tr>
            ...
            <td><?php echo $compte->jury_discipline; ?></td>
          </tr>
          <tr>
            <th style="width: 40%;vertical-align: text-top;">Biographie</th>
            <td><?php echo $compte->jury_biographie; ?></td>
          </tr>
          <tr>
            <th style="width: 40%;vertical-align: text-top;">URL site web</th>
            <td><?php if( $compte->jury_url != NULL )
            {
              echo $compte->jury_url;
            }else
            {
        ...
        <tr>
          <td style="text-align: center;" colspan="2">
            <a href='<?php echo base_url()."index.php/jury/modif_mdp_compte" ?>'>
