...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
	...
	<tbody>
		...
		<tr>
			...
			<td><a class="btn btn-dark btn-sm btn-block" href="#" role="button">Plus d'info...</a>
				<?php if($cnc["phase"]=="Evaluation" && $cnc["nbPre"] != 0) { ?>
					<a class="btn btn-warning btn-sm btn-block" href="<?php echo base_url()."index.php/jury/afficher_preselection/".$cnc["cnc_id"]?>" role="button">Candidats Présélectionnés</a>
